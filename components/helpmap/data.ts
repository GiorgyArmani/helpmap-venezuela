...
export const T: Record<Lang, Strings> = {
  es: {
    ...
    storyDownloaded: "Abrimos la imagen: mantén pulsado para guardarla y súbela a tu historia de Instagram.",
  ...
  en: {
    ...
    storyDownloaded: "We opened the image: press and hold to save it, then upload it to your Instagram story.",
